...
| --- | --- |
| [webrtc_client.py](src/ready/apis/holoscan/webrtc_ready/webrtc_client.py) with model _weights_15-12-24_07-00-10-sim-BHWC.onnx, running `drop_frames_op` at different `PeriodicCondition(self, recess_period=period_ns)` 1 to 30 Hz. | [:nut_and_bolt: Launch and debug api](docs/holoscan/apis_webrtc_ready.md)               [:hourglass: flowbenchmarking](data/webrtc/flow_benchmarking/).  |
