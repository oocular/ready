...
if [[ $1 == LOCAL ]]; then
    ...
    export HOLOSCAN_LOG_LEVEL=$2
    clear && python webrtc_client.py --logger_filename ${recorder_directory}/${recorder_basename}_${recorder_loggername}_${recorder_loggerextension} --model_name ${model_name} --models_path_map ${model_pathMap} --source $3 --enable_recording $4 --recording_directory ${recorder_directory} --recording_basename ${recorder_basename}
elif [[ $1 == PUBLIC ]]; then
    echo $1 PUBLIC network
    export HOLOSCAN_LOG_LEVEL=$2
    clear && python webrtc_client.py --cert-file ${workspace_keysPath}/MyCertificate.crt --key-file ${workspace_keysPath}/MyKey.key --logger_filename ${recorder_directory}/${recorder_basename}_${recorder_loggername}_${recorder_loggerextension} --model_name ${model_name} --models_path_map ${model_pathMap} --source $3 --enable_recording $4 --recording_directory ${recorder_directory} --recording_basename ${recorder_basename}
else
